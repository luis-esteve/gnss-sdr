...
public:
    ...
    void Carrier_wipeoff_and_multiEPL_volk(int signal_length_samples, const gr_complex* input, gr_complex* carrier, gr_complex* code, unsigned int num_correlators, unsigned int * index, gr_complex* out);
    Correlator();
    ~Correlator();
